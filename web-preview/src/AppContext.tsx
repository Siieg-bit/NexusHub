...
interface AppContextType {
  ...
  toggleCheckIn: (communityId: string) => void;
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const toggleCheckIn = useCallback((communityId: string) => {
    setComms(prev => prev.map(c => c.id === communityId ? { ...c, checkedIn: !c.checkedIn } : c));
  }, []);
  ...
  return (
    <AppContext.Provider value={{
      ...
      checkIn, toggleCheckIn, sendMessage, votePoll, screenHistory, goBack, navigateTo, getCommunityProfile, getCommunitiesByCategory, searchCommunities, earnReputation,
    }}>
      {children}
    </AppContext.Provider>
  );
