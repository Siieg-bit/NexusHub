-- Migration 142: Adicionar suporte a media_blurhash na RPC send_chat_message_with_reputation
-- Atualiza a RPC para aceitar e persistir o BlurHash da mídia junto com a mensagem.
...
-- Revogar grant antigo (assinatura sem p_media_blurhash) e conceder novo
...
GRANT EXECUTE ON FUNCTION public.send_chat_message_with_reputation(
  UUID, TEXT, TEXT, TEXT, TEXT, INTEGER, UUID, TEXT, TEXT, TEXT, TEXT, TEXT
) TO authenticated;
