...
class _WikiCuratorReviewScreenState
    extends ConsumerState<WikiCuratorReviewScreen> {
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              Navigator.pop(ctx, text.isNotEmpty ? text : s.noReasonSpecified);
            },
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _PendingWikiCard(
                          entry: entry,
                          onApprove: () =>
                              _reviewEntry(entry['id'] as String, 'approve'),
                          onReject: () =>
                              _reviewEntry(entry['id'] as String, 'reject'),
                          onTap: () =>
