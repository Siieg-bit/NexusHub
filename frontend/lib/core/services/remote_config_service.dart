...
class RemoteConfigService {
  ...
  static bool get isRemoteLevelDefinitionsEnabled =>
      getBool('features.remote_level_definitions_enabled', fallback: true);
  static bool get isRemoteAnnouncementsEnabled =>
