...
// A extension NexusColors foi removida para evitar conflito com NexusThemeContext
// (definida em nexus_theme_extension.dart).
// Use context.nexusTheme.* ou os aliases context.scaffoldBg, context.surfaceColor,
// context.cardBg, context.dividerClr, context.textPrimary, etc.
// que estão definidos em NexusThemeContext e são totalmente reativos ao tema ativo.
